...
<Note>
This endpoint supports **mask mode only**. Route mode is available for the OpenAI endpoint. The request format follows the [Anthropic Messages API](https://docs.anthropic.com/en/api/messages).
</Note>
