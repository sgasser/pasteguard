...
#
# Build: docker build --build-arg LANGUAGES=en -t pasteguard:en .
...
COPY presidio/languages.yaml /build/
COPY presidio/scripts/generate-configs.py /build/
...
COPY supervisord.conf /etc/supervisor/conf.d/pasteguard.conf
